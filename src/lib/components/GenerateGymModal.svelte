<script lang="ts">
  ...
  const examplePrompts = [
    { label: "Video Editing", text: "Video editing with tools like Premiere Pro, After Effects, and DaVinci Resolve" },
    { label: "Gaming", text: "Playing and streaming Steam games, managing game libraries, and configuring game settings" },
    { label: "Food Ordering", text: "Ordering food on platforms like DoorDash, UberEats, and Grubhub" },
    { label: "Spreadsheets", text: "Creating and managing spreadsheets in Excel, Google Sheets, or other tools" },
    { label: "Documents", text: "Writing and editing documents in Word, Google Docs, or other word processors" },
    { label: "Coding", text: "Using VSCode or other IDEs for programming, debugging, and version control" },
    { label: "3D Modeling", text: "Creating 3D models and animations in Blender, Maya, or other modeling software" },
    { label: "Social Media", text: "Engaging on Twitter, Instagram, and other social platforms" },
    { label: "Community Management", text: "Setting up and managing Discord servers, Telegram groups, or Slack workspaces" },
    { label: "Crypto Trading", text: "Trading cryptocurrency on exchanges, managing wallets, and analyzing market trends" }
  ];
                        ...
                        <div class="flex items-center gap-2 mb-2">
                          <div class="w-6 h-6 flex items-center justify-center">
                            <img 
                              ...
                              class="w-5 h-5"
                              onerror={(e) => {
                                (e.currentTarget as HTMLImageElement).src = 'data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><rect width=%2218%22 height=%2218%22 x=%223%22 y=%223%22 rx=%222%22 ry=%222%22></rect><path d=%22M9 17V9l7 4-7 4Z%22></path></svg>';
                              }}
                            />
                          </div>
                          <div 
