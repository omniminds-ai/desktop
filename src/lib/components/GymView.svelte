    ...
    <div class="mb-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <a href="/app/gym/chat?prompt=Free%20Race" class="block">
          <Card
            padding="lg"
            className="hover:scale-[1.02] hover:border-secondary-300 border-2 transition-all cursor-pointer">
        ...
        <a href="/app/gym/chat?prompt=Paint%20Buddy" class="block">
          <Card
            ...
            <div class="flex flex-col h-full">
              ...
              <p class="text-gray-600 mb-6">Let our AI guide you with artistic adventures</p>
            </div>
          </Card>
        </a>
        ...
        <a href="/app/gym/chat?prompt=Office%20Helper" class="block">
          <Card
            ...
            <div class="flex flex-col h-full">
              <div
                class="w-10 h-10 sm:w-12 sm:h-12 bg-secondary-100/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4">
                <FileSpreadsheet class="w-5 h-5 sm:w-6 sm:h-6 text-secondary-300" />
              </div>
