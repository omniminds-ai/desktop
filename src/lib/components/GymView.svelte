...
<div class="h-full">
  <div class="p-4">
    <div class="mb-12">
      <h2 class="text-2xl font-title text-secondary-300 mb-6">
        Start Training
      </h2>
        ...
        <a href="/app/gym/chat?prompt=Random%20Challenge" class="block">
          ...
          >
            <div class="flex flex-col h-full">
              ...
              <h3 class="text-lg sm:text-xl font-title mb-2">
                Random Challenge
              </h3>
              <p class="text-gray-600 mb-6">
                Our AI guides you through random Linux tasks
              </p>
              <button
                class="mt-auto px-4 py-2 bg-secondary-300 text-white rounded-lg hover:bg-secondary-400 transition-colors"
              >
                Join Race
              </button>
            </div>
          ...
          >
            <div class="flex flex-col h-full">
              <div
                class="w-10 h-10 sm:w-12 sm:h-12 bg-secondary-100/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4"
              >
                <Palette class="w-5 h-5 sm:w-6 sm:h-6 text-secondary-300" />
              </div>
              <h3 class="text-lg sm:text-xl font-title mb-2">Paint Buddy</h3>
              <p class="text-gray-600 mb-6">
                Let our AI guide your browser-based artistic adventures
              </p>
              <button
                class="mt-auto px-4 py-2 bg-secondary-300 text-white rounded-lg hover:bg-secondary-400 transition-colors"
              >
        ...
        <a href="/app/gym/chat?prompt=Office%20Helper" class="block">
          ...
          >
            <div class="flex flex-col h-full">
              ...
              <p class="text-gray-600 mb-6">
                Follow along with spreadsheet and document tasks
              </p>
              <button
                class="mt-auto px-4 py-2 bg-secondary-300 text-white rounded-lg hover:bg-secondary-400 transition-colors"
              >
