      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          {#if enableUploadLimit}
            <div class="pl-6 mt-2">
              <label for="upload-limit-value" class="block text-sm font-medium text-gray-700 mb-1">
                Upload Limit
              </label>
              <Input
        ...
        <div>
          ...
          {#if enableRewardLimit}
            <div class="pl-6 mt-2">
              <label for="reward-limit-value" class="block text-sm font-medium text-gray-700 mb-1">
                Price per demonstration
              </label>
              <div class="flex items-center gap-2">
                <Input
                  id="reward-limit-value"
                  type="number"
                  min="1"
                  step="1"
                  variant="light"
